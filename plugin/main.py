...
class MetaPlugin(BasePlugin):
    ...
    def on_post_page(self, output, page, config):
        if not config["site_url"]:
            print("WARNING - mkdocs-ultralytics-plugin: Please add a 'site_url' to your mkdocs.yml to enable all Ultralytics features, i.e. 'site_url: https://docs.ultralytics.com'")
