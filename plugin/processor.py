...
def process_html(
    ...
    if add_desc and "description" in meta:
        if meta_desc := soup.find("meta", attrs={"name": "description"}):
            ...
            soup.head.append(soup.new_tag("meta", attrs={"name": "description", "content": meta["description"]}))
    ...
    if (
        ...
        copy_button = soup.new_tag(
            ...
            attrs={"class": "md-content__button md-icon", "title": "Copy page in Markdown format"},
        )
